		...
		<form id="registerform" class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath }/user?method=register" method="post">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    &nbsp;&nbsp;&nbsp;<a onclick="refreshImage()">刷新一下</a>
			    
			  </div>
			 
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <input id="submit" type="submit"  width="100" value="注册" name="submit" border="0"
	...
	<div style="margin-top:50px;">
		...
		<script type="text/javascript">
			function refreshImage(){
				...
				obj.setAttribute("src", "/store/servlet/CodeServlet?id"+i);
			}
			$(function(){
				//验证用户名是否存在
				var url = "/store/user";
				$("#username").blur(function(){
					var param = {"username":$("#username").val(),"method":"checkUsernameIsExist"};
					$.post(
						url,
						param,
						function(data){
							if(data==0)
							{
								$("#checkUsername").html("用户名未被占用");
								$("submit").attr("disabled",false);
							}
							else
							{
								$("#checkUsername").html("<font color='red'>用户名已被占用<font>");
